...
Pemetaan representasi teks profil lowongan kerja ($u$) dan profil pelamar ($v$) ke dalam ruang vektor berdimensi tinggi (*768-dim* pada Gemini `text-embedding-004` atau *1536-dim* pada OpenAI `text-embedding-3-small`):
